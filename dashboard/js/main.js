...
const e_homeButton = document.getElementById('home-button');
...
function renderBoard(board) {
    ...
    document.title = 'HireE | ' + currentBoard().name;
...
class Card {
    ...
    generateElement() {
        ...
        _newCardHeaderTitle.classList.add('text-align-center', 'card-title');
...
function loadData() {
    ...
    if (_data) {
        ...
        let _defaultBoard = new Board("Hiring Dashboard", 'b0', {'theme': null});
...
e_homeButton.addEventListener('click',function () {
